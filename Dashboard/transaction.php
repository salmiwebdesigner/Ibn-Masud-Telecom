    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li class="dropdown">
                <li><a href=""><i class="material-icons">home</i><span>Transactions</span></a></li>
            ...
            <div class="top-navbar">
                <nav class="navbar navbar-expand-lg">
                    <div class="container-fluid">
                        ...
                        <a class="navbar-brand" href="./transaction.php">Transactions </a>
                    ...
                    <div class="container-fluid w-auto rounded h-auto">
                        <div class="card" style="min-height: 485px;">
                            <div class="card-header card-header-text">
                                <h4 class="card-title text-center font-weight-bold text-primary">Page Coming Soon</h4>
                            </div>
